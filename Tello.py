...
class Tello:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.drone.connect()
            # 2=1.6Mbps,1=1.1Mbps,3=2.1Mbps,4=3.2Mbps,5=4.2Mbps
            self.drone.set_video_encoder_rate(1)
            self.drone.start_video()

            # 订阅飞行数据信息
            self.drone.subscribe(
                self.drone.EVENT_FLIGHT_DATA, self.flight_data_handler)
    ...
    def flight_data_handler(self, event, sender, data):
        ...
        # 起飞11，降落12，没有起飞：6静止可以起飞，1未静止不可起飞：飞行中：6视觉定位正常，1飘了
